...
<script>
    ...
    layui.use(['form','jquery','layer','table'],function(){
        ...
        var t = {
            elem: '#demo',
            url:'${basePath!}/admin/system/table/showFields',
            method:'post',
        ...
        form.verify({
            ...
            fieldname:function (value,item) {
                ...
                $.ajax({
                    url:"${basePath!}/admin/system/table/fieldIsExist",
                    type:'POST',
        ...
        var addbutton = function () {
            ...
            $('#doforSelect').delegate('.layui-btn-danger','click', function() {
                ...
                if(dictid != null && dictid !== ""){
                    $.post("${basePath!}/admin/system/dict/deleteById",{id:dictid},function (res) {
                        if(res.success){
                            _this.remove();
        ...
        form.on("submit(fieldFilter)",function (data) {
            ...
            if(flag){
                ...
                $.ajax({
                    type:"POST",
                    url:"${basePath!}/admin/system/table/addField",
                    dataType:"json",
        ...
        form.on("submit(editfield)",function (data) {
            ...
            if(flag){
                ...
                $.ajax({
                    type:"POST",
                    url:"${basePath!}/admin/system/table/editField",
                    dataType:"json",
                    contentType:"application/json",
                    data:JSON.stringify(data.field),
                    success:function(res){
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('真的删除行么', function(index){
                    obj.del();
                    //删除表格数据
                    $.post("${basePath!}/admin/system/table/deleteField",{fieldName:data.name,tableName:'${tableVO.name}'},function(res){
                        if(res.success){
        ...
        form.on("submit(addUser)",function(data){
            ...
            $.post('${basePath!}/admin/system/table/editTable',data.field,function (res) {
                layer.close(loadIndex);
                if(res.success){
