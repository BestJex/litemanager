...
<div class="layui-form users_list">
    ...
    <script type="text/html" id="barDemo">
        ...
        <a class="layui-btn layui-btn-xs" href="javascript:" data-url="${basePath!}/table/edit?name={{d.name}}" lay-event="edit"><cite>编辑</cite></a>
...
<script type="text/javascript" src="${basePath!}/static/js/tools.js?t=1"></script>
<script>
    layui.use(['layer','form','table','element'], function() {
        ...
        t = {
            elem: '#test',
            url:'${basePath!}/admin/system/table/list',
            method:'post',
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'edit'){
                ...
                var editIndex = layer.open({
                    ...
                    type : 2,
                    area: ['1000px', '1000px'],
                    content : "${basePath!}/admin/system/table/edit?name="+data.name,
            ...
            if(obj.event === "del"){
                layer.confirm("你确定要删除该数据表么,删除之后不可恢复？",{btn:['是的,我确定','我再想想']},
                        function(){
                            $.post("${basePath!}/admin/system/table/delete",{"tableName":data.name},function (res){
                                if(res.success){
        ...
        var active={
            addUser : function(){
                var addIndex = layer.open({
                    title : "新增数据表",
                    type : 2,
                    content : "${basePath!}/admin/system/table/add",
            ...
            getCheckData: function(){ //获取选中数据
                ...
                <#--var url = '${basePath!}/admin/system/table/download',-->
                ...
                var config = $.extend(true, { method: 'post' }, {
                    url:"${basePath!}/admin/system/table/download",
