...
<head>
    ...
    <link rel="stylesheet" href="${basePath!}/static/colorpicker/css/jquery-ui.min.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="${basePath!}/static/colorpicker/css/evol-colorpicker.css" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="${basePath!}/static/layui/layui.js"></script>
    <script type="text/javascript" src="${basePath!}/static/colorpicker/js/jquery.min.js"></script>
    <script type="text/javascript" src="${basePath!}/static/colorpicker/js/jquery-ui.min.js"></script>
    <script type="text/javascript" src="${basePath!}/static/colorpicker/js/evol-colorpicker.js"></script>
...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input style="width:80px;" id="bgColor" name="bgColor" class="colorPicker evo-cp0" value="${menu.bgColor}"/>
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    ...
    layui.use(['form','jquery','layer'],function(){
        ...
        form.on("submit(editMenu)",function(data){
            ...
            $.post("${basePath!}/admin/system/menu/edit",data.field,function (res) {
