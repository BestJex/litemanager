...
<script>
    layui.use(['layer','form','table'], function() {
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'edit'){
                var editIndex = layer.open({
                    title : "编辑角色",
                    type : 2,
                    content : "${basePath!}/admin/system/role/edit?id="+data.id,
            ...
            if(obj.event === "del"){
                layer.confirm("你确定要删除该角色么？",{btn:['是的,我确定','我再想想']},
                        function(){
                            $.post("${basePath!}/admin/system/role/delete",{"id":data.id},function (res){
                                if(res.success){
        ...
        t = {
            elem: '#test',
            even: true,
            url:'${basePath!}/admin/system/role/list',
            method:'post',
        ...
        var active={
            addUser : function(){
                    ...
                    title : "添加角色",
                    type : 2,
                    content : "${basePath!}/admin/system/role/add",
                ...
                if(data.length > 0){
                    ...
                    layer.confirm("你确定要删除这些角色么？",{btn:['是的,我确定','我再想想']},
                            function(){
                                ...
                                $.ajax({
                                    type:"POST",
                                    url:"${basePath!}/admin/system/role/deleteSome",
                                    dataType:"json",
