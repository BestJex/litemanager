package com.litemanager.admin.util;
...
//         gc.setControllerName("%s");
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/litemanager?useUnicode=true&characterEncoding=UTF-8");
...
//        strategy.setExclude(new String[]{"sys_user_role","sys_role_menu","sys_group_ur"}); // 排除生成的表
        // 自定义实体父类
        strategy.setSuperEntityClass("com.litemanager.admin.base.DataEntity");
        // 自定义实体，公共字段
