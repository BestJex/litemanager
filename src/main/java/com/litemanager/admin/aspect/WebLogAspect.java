package com.litemanager.admin.aspect;

import com.alibaba.fastjson.JSONObject;
import com.litemanager.admin.base.MySysUser;
import com.litemanager.admin.entity.Log;
import com.litemanager.admin.exception.GlobalExceptionHandler;
import com.litemanager.admin.util.ToolUtil;
...
public class WebLogAspect {
    ...
    @Pointcut("@annotation(com.litemanager.admin.annotation.SysLog)")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        com.litemanager.admin.annotation.SysLog mylog = method.getAnnotation(com.litemanager.admin.annotation.SysLog.class);
        if(mylog != null){
            //注解上的描述
